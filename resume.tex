...
\newline
Worked extensively with these technologies: Docker, Avro, Kafka, PostgreSQL, Spark, Git, AWS, Django, Flask, Linux
\newline
Rely on these DevOps Tools: Terraform, Ansible, Packer, Jenkins, Splunk, Grafana, Elasticsearch, xMatters
\end{resumeSection}
\hfill \newline
