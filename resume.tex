...
\begin{tabular}{ l @{\hspace{17em}} p{0.3\textwidth} @{\hspace{4em}} r}
Denver, CO & (847) 404-3386 & \href{mailto:adam@adambloom.net}{adam@adambloom.net}\\
\end{tabular}
\vspace{1em} \newline
\begin{resumeSection}{Summary}
Experienced software leader with 9+ years of experience solving challenging problems spanning from system architecture, data processing, monitoring and observability, to end-to-end software debugging of distributed systems.
\end{resumeSection}
\hfill \newline
